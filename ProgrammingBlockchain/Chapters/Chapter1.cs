...
namespace ProgrammingBlockchain.Chapters
{
    class Chapter1
    {
        public void Lesson1()
        {
            ...
            Console.WriteLine("ScriptPubKey: {0}", scriptPubKeyFromAddress);

            Script scriptPubKeyFromHash = hash.ScriptPubKey;
            Console.WriteLine("ScriptPubKey: {0}", scriptPubKeyFromHash);
        }

        public void Lesson2()
        {
            var scriptPubKey = new Script(script: "OP_DUP OP_HASH160 1b2da6ee52ac5cd5e96d2964f12a0241851f8d2a OP_EQUALVERIFY OP_CHECKSIG");
        ...
        public void Lesson3()
        {
            var scriptPubKey = new Script("OP_DUP OP_HASH160 1b2da6ee52ac5cd5e96d2964f12a0241851f8d2a OP_EQUALVERIFY OP_CHECKSIG");
            var hash = (KeyId)scriptPubKey.GetDestination();
